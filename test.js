var arrOfMinutes = [1.00,1.10,1.20,1.30,1.40,1.50
    ,2.00,2.10,2.20,2.30,2.40,2.50
    ,3.00,3.10,3.20,3.30,2.40,3.50
...
for (i = 0; i < arrOfMinutes.length; i++) {
    if(arrOfMinutes[i] % parseInt(arrOfMinutes[i]) === 0){
    console.log(arrOfMinutes[i])
}
}